...
//TODO Modificare.............
    ...
    private void composeNewNotification(NewNotificationRequestV23 request, NotificationDocument notificationDocument, boolean isAlist, boolean noUpload, int overAllegato) throws IOException {
        ...
        request.setDocuments(newdocs);
        setAttachementAndMetadata(request);
        log.info("New Notification Request {}", request);
    }
    ...
    private void setAttachementAndMetadata(NewNotificationRequestV23 newNotificationRequestV23) throws IOException {
...
//        PnNotificationDataDocument pnNotificationDocument = new PnNotificationDataDocument();
//        PnNotificationData pnNotification = new PnNotificationData(document);
//        pnNotificationDocument.preloadGeneric(pnNotification, preloadDocument.getValue1(), preloadDocument.getValue2());
//        return pnNotification.getNotificationDocument();
        document.getRef().setKey(preloadDocument.getValue1());
        document.getRef().setVersionToken("v1");
        document.digests(new NotificationAttachmentDigests().sha256(preloadDocument.getValue2()));
        return document;
    }
    ...
    public it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationDocument preloadDocumentV1(it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationDocument document) throws IOException {
        Pair<String, String> preloadDocument = preloadGeneric(document.getRef().getKey(), loadToPresigned);
//        PnNotificationDataDocumentV1 pnNotificationDocumentV1 = new PnNotificationDataDocumentV1();
//        PnNotificationDataV1 pnNotificationV1 = new PnNotificationDataV1(document);
//        pnNotificationDocumentV1.preloadGeneric(pnNotificationV1, preloadDocument.getValue1(), preloadDocument.getValue2());
//        return pnNotificationV1.getNotificationDocument();
        document.getRef().setKey(preloadDocument.getValue1());
        document.getRef().setVersionToken("v1");
        document.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationAttachmentDigests().sha256(preloadDocument.getValue2()));
        return document;
    }
    ...
    public it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationDocument preloadDocumentV2(it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationDocument document) throws IOException {
        Pair<String, String> preloadDocument = preloadGeneric(document.getRef().getKey(), loadToPresigned);
//        PnNotificationDataDocumentV20 pnNotificationDocumentV20 = new PnNotificationDataDocumentV20();
//        PnNotificationDataV20 pnNotificationV20 = new PnNotificationDataV20(document);
//        pnNotificationDocumentV20.preloadGeneric(pnNotificationV20, preloadDocument.getValue1(), preloadDocument.getValue2());
//        return pnNotificationV20.getNotificationDocument();
        document.getRef().setKey(preloadDocument.getValue1());
        document.getRef().setVersionToken("v1");
        document.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationAttachmentDigests().sha256(preloadDocument.getValue2()));
        return document;
    }
    ...
    public it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationDocument preloadDocumentV21(it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationDocument document) throws IOException {
        Pair<String, String> preloadDocument = preloadGeneric(document.getRef().getKey(), loadToPresigned);
//        PnNotificationDataDocumentV21 pnNotificationDocumentV21 = new PnNotificationDataDocumentV21();
//        PnNotificationDataV21 pnNotificationV21 = new PnNotificationDataV21(document);
//        pnNotificationDocumentV21.preloadGeneric(pnNotificationV21, preloadDocument.getValue1(), preloadDocument.getValue2());
//        return pnNotificationV21.getNotificationDocument();
        document.getRef().setKey(preloadDocument.getValue1());
        document.getRef().setVersionToken("v1");
        document.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationAttachmentDigests().sha256(preloadDocument.getValue2()));
        return document;
    }
...
//        return pnNotification.getNotificationDocument();
        document.getRef().setKey(preloadDocument.getValue1());
        document.getRef().setVersionToken("v1");
        document.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.NotificationAttachmentDigests().sha256(preloadDocument.getValue2()));
        return document;
    }
...
//            PnNotificationDataDocument pnNotificationDocument = new PnNotificationDataDocument();
//            PnNotificationData pnNotification = new PnNotificationData(attachment);
//            pnNotificationDocument.preloadGeneric(pnNotification, preloadAttachment.getValue1(), preloadAttachment.getValue2());
//            return pnNotification.getNotificationPaymentAttachment();
            attachment.getRef().setKey(preloadAttachment.getValue1());
            attachment.getRef().setVersionToken("v1");
            attachment.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.NotificationAttachmentDigests().sha256(preloadAttachment.getValue2()));
            return attachment;
        }
        return null;
    }
    ...
    public it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationPaymentAttachment preloadAttachmentV1( it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationPaymentAttachment attachment) throws IOException {
        if(attachment != null) {
            Pair<String, String> preloadAttachment = preloadGeneric(attachment.getRef().getKey(), loadToPresigned);
//            PnNotificationDataDocumentV1 pnNotificationDocumentV1 = new PnNotificationDataDocumentV1();
//            PnNotificationDataV1 pnNotificationV1 = new PnNotificationDataV1(attachment);
//            pnNotificationDocumentV1.preloadGeneric(pnNotificationV1, preloadAttachment.getValue1(), preloadAttachment.getValue2());
//            return pnNotificationV1.getNotificationPaymentAttachment();
            attachment.getRef().setKey(preloadAttachment.getValue1());
            attachment.getRef().setVersionToken("v1");
            attachment.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationAttachmentDigests().sha256(preloadAttachment.getValue2()));
            return attachment;
        }
        return null;
    }
    ...
    public it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationPaymentAttachment preloadAttachmentV2( it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationPaymentAttachment attachment) throws IOException {
        if(attachment != null) {
            Pair<String, String> preloadAttachment = preloadGeneric(attachment.getRef().getKey(), loadToPresigned);
//            PnNotificationDataDocumentV20 pnNotificationDocumentV20 = new PnNotificationDataDocumentV20();
//            PnNotificationDataV20 pnNotificationV20 = new PnNotificationDataV20(attachment);
//            pnNotificationDocumentV20.preloadGeneric(pnNotificationV20, preloadAttachment.getValue1(), preloadAttachment.getValue2());
//            return pnNotificationV20.getNotificationPaymentAttachment();
            attachment.getRef().setKey(preloadAttachment.getValue1());
            attachment.getRef().setVersionToken("v1");
            attachment.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationAttachmentDigests().sha256(preloadAttachment.getValue2()));
            return attachment;
        }
        return null;
    }
    ...
    public it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationPaymentAttachment preloadAttachmentV21( it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationPaymentAttachment attachment) throws IOException {
        if(attachment != null) {
            Pair<String, String> preloadAttachment = preloadGeneric(attachment.getRef().getKey(), loadToPresigned);
//            PnNotificationDataDocumentV21 pnNotificationDocumentV21 = new PnNotificationDataDocumentV21();
//            PnNotificationDataV21 pnNotificationV21 = new PnNotificationDataV21(attachment);
//            pnNotificationDocumentV21.preloadGeneric(pnNotificationV21, preloadAttachment.getValue1(), preloadAttachment.getValue2());
//            return pnNotificationV21.getNotificationPaymentAttachment();
            attachment.getRef().setKey(preloadAttachment.getValue1());
            attachment.getRef().setVersionToken("v1");
            attachment.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationAttachmentDigests().sha256(preloadAttachment.getValue2()));
            return attachment;
        }
        return null;
    }
...
//            PnNotificationData pnNotification = new PnNotificationData(attachment);
//            pnNotificationDocument.preloadGeneric(pnNotification, preloadAttachment.getValue1(), preloadAttachment.getValue2());
//            return pnNotification.getNotificationMetadataAttachment();
            attachment.getRef().setKey(preloadAttachment.getValue1());
            attachment.getRef().setVersionToken("v1");
            attachment.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.NotificationAttachmentDigests().sha256(preloadAttachment.getValue2()));
            return attachment;
...
//            PnNotificationDataV21 pnNotificationV21 = new PnNotificationDataV21(attachment);
//            pnNotificationDocumentV21.preloadGeneric(pnNotificationV21, preloadAttachment.getValue1(), preloadAttachment.getValue2());
//            return pnNotificationV21.getNotificationMetadataAttachment();
            attachment.getRef().setKey(preloadAttachment.getValue1());
            attachment.getRef().setVersionToken("v1");
            attachment.digests(new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationAttachmentDigests().sha256(preloadAttachment.getValue2()));
            return attachment;
...
//            return pnNotification.getNotificationMetadataAttachment();
    ...
    private Pair<String, String> preloadGeneric(String resourceName, String loadToMetadata) throws IOException {
        ...
        PreLoadResponse preLoadResponse = null;
