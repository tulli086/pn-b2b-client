Feature: costo notifica con workflow analogico per persona giuridica 890
  ...
  @dev @costoCartAAR
  Scenario: [B2B_COSTO_ANALOG_PG_890_1_AAR] Invio notifica e verifica costo con FSU + @OK_890 + DELIVERY_MODE positivo
    Given viene generata una nuova notifica
      | subject               | notifica analogica con cucumber |
      | senderDenomination    | Comune di palermo               |
      | physicalCommunication | REGISTERED_LETTER_890           |
  ...
  @dev @costoCartAAR
  Scenario: [B2B_COSTO_ANALOG_PG_890_3_AAR] Invio notifica con allegato e verifica costo con FSU + @OK_890 + DELIVERY_MODE positivo
    Given viene generata una nuova notifica
      | subject               | notifica analogica con cucumber |
      | senderDenomination    | Comune di palermo               |
      | physicalCommunication | REGISTERED_LETTER_890           |
  ...
  @dev @costoCartAAR
  Scenario: [B2B_COSTO_ANALOG_PG_890_5_AAR] Invio notifica e verifica costo con RECAPITISTA + @OK_890 + DELIVERY_MODE positivo
    Given viene generata una nuova notifica
      | subject               | notifica analogica con cucumber |
      | senderDenomination    | Comune di palermo               |
      | physicalCommunication | REGISTERED_LETTER_890           |
  ...
  @dev @costoCartAAR
  Scenario: [B2B_COSTO_ANALOG_PG_890_7_AAR] Invio notifica con allegato e verifica costo con RECAPITISTA + @OK_890 + DELIVERY_MODE positivo
    Given viene generata una nuova notifica
      | subject               | notifica analogica con cucumber |
      | senderDenomination    | Comune di palermo               |
      | physicalCommunication | REGISTERED_LETTER_890           |
