...
public class AvanzamentoNotificheWebhookB2bSteps {
  ...
  @Autowired
  public AvanzamentoNotificheWebhookB2bSteps(IPnWebhookB2bClient webhookB2bClient,
      ...
      for (SettableApiKey.ApiKeyType pa : paForStream.values()) {
        ...
        for (it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.model_v2.StreamListElement elem : streamListElements) {
          try {
            ...
            log.error("HTTP Error: statusCode {} message {}", statusCodeException.getStatusCode(),
...
//        }
  ...
  public void setUpStreamsWithEventType(int number, String title, String eventType,
    ...
    createStreamRequest(StreamVersion.valueOf(version.trim().toUpperCase()), new LinkedList<>(),
        number, title, eventType);
  }
  ...
  public void createdStreamByFilterValue(String pa, String version, String filter) {
    setPaWebhook(pa);
    createStream(pa, StreamVersion.valueOf(version.trim().toUpperCase()), null, false,
  ...
  public void siCreaIlNuovoStreamPerIlConVersioneFORZATOSoloPerCasoErrato(String pa,
      String version) {
    setPaWebhook(pa);
  ...
  public void updateGroupsStreamUpadateApiKey(String action, String versione, String pa) {
    ...
    if (sharedSteps.getRequestNewApiKey() != null) {
      ...
      if ("rimuove".equalsIgnoreCase(action) && sharedSteps.getRequestNewApiKey() != null
  ...
  private void updateStreamByGroupsPA(String version, String pa, boolean groupOfPa) {
    ...
    try {
      streamRequestV23 = new StreamRequestV23();
      streamRequestV23.setGroups(
          List.of(sharedSteps.getGroupIdByPa(groupToUse, GroupPosition.FIRST)));
    ...
    switch (versione) {
      ...
      case "V23":
        try {
          ...
          streamRequestV23.setEventType(StreamRequestV23.EventTypeEnum.TIMELINE);
          for (StreamMetadataResponseV23 eventStream : eventStreamListV23) {
            StreamMetadataResponseV23 result = webhookB2bClient.updateEventStreamV23(
                eventStream.getStreamId(), streamRequestV23);
  ...
  public void updateStreamNotexist() {
    ...
    try {
      ...
      streamRequestV23.setEventType(StreamRequestV23.EventTypeEnum.TIMELINE);
      webhookB2bClient.updateEventStreamV23(this.eventStreamListV23.get(0).getStreamId(),
          streamRequestV23);
    } catch (HttpStatusCodeException e) {
      this.notificationError = e;
      sharedSteps.setNotificationError(e);
  ...
  public void verifiedTheCorrectDeletion(String versione) {
    switch (versione) {
      case "V10":
        ...
        for (StreamMetadataResponse eventStream : eventStreamList) {
          it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.model_v2.StreamListElement streamListElement = streamListElements.stream()
              .filter(elem -> elem.getStreamId() == eventStream.getStreamId()).findAny()
              .orElse(null);
      ...
      case "V23":
        ...
        for (StreamMetadataResponseV23 eventStream : eventStreamListV23) {
          it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.model_v2_3.StreamListElement streamListElementV23 = streamListElementsV23.stream()
              .filter(elem -> elem.getStreamId() == eventStream.getStreamId()).findAny()
              .orElse(null);
  ...
  public void readStreamEventsV23() {
    updateApiKeyForStream();
    try {
      List<ProgressResponseElementV23> progressResponseElements = webhookB2bClient.consumeEventStreamV23(
          this.eventStreamListV23.get(0).getStreamId(), null);
  ...
  public void readStreamEventsState(String pa, String status) {
    ...
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.NotificationStatus notificationInternalStatus =
        it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.NotificationStatus.valueOf(
            statusEventForStream.notificationStatus.name());
    ...
    for (int i = 0; i < numCheck; i++) {
      ...
      sharedSteps.setSentNotification(
          b2bClient.getSentNotification(sharedSteps.getSentNotification().getIun()));
      NotificationStatusHistoryElement notificationStatusHistoryElement = sharedSteps.getSentNotification()
          .getNotificationStatusHistory().stream()
          .filter(elem -> elem.getStatus().equals(notificationInternalStatus)).findAny()
          .orElse(null);
    ...
    try {
      ...
      String message = assertionFailedError.getMessage() +
          " {IUN: " + sharedSteps.getSentNotification().getIun() + " -WEBHOOK: "
          + this.eventStreamList.get(0).getStreamId() + " }";
      throw new AssertionFailedError(message, assertionFailedError.getExpected(),
          assertionFailedError.getActual(), assertionFailedError.getCause());
    }
  ...
  public void readStreamEventsStateV23(String pa, String status) {
    ...
    try {
      ...
      String message = assertionFailedError.getMessage() +
          " {IUN: " + sharedSteps.getSentNotification().getIun() + " -WEBHOOK: "
          + this.eventStreamListV23.get(0).getStreamId() + " }";
      throw new AssertionFailedError(message, assertionFailedError.getExpected(),
          assertionFailedError.getActual(), assertionFailedError.getCause());
    }
  ...
  public void readStreamTimelineElement(String pa, String timelineEventCategory) {
    ...
    TimelineElementSearchResult<TimelineElementCategoryV20> timelineForStream = getTimelineEventForStream(
        V10, timelineEventCategory);
    ...
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementCategoryV23 timelineElementInternalCategory =
        it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementCategoryV23.valueOf(
    ...
    try {
      ...
      Assertions.assertFalse(sharedSteps.getSentNotification()
          ...
          .filter(elem -> elem.getCategory().equals(timelineElementInternalCategory)
              && elem.getTimestamp().truncatedTo(ChronoUnit.SECONDS)
              .equals(finalProgressResponseElement.getTimestamp().truncatedTo(ChronoUnit.SECONDS)))
          .findAny()
          .isEmpty());
      log.info("EventProgress: " + progressResponseElement);
  ...
  public void readStreamTimelineElementV23(String pa, String timelineEventCategory) {
    ...
    TimelineElementSearchResult<TimelineElementCategoryV23> timelineForStream = getTimelineEventForStream(
        StreamVersion.V23, timelineEventCategory);
    ...
    try {
      ...
      Assertions.assertEquals(
          progressResponseElement.getElement().getTimestamp().truncatedTo(ChronoUnit.SECONDS),
  ...
  private void verifyNotEventInStream(String pa, StreamVersion streamVersion) {
    ...
    updateApiKeyForStream();
    switch (streamVersion) {
      case V10 -> Assertions.assertTrue(
          webhookB2bClient.consumeEventStream(this.eventStreamList.get(0).getStreamId(), null)
              .isEmpty());
      case V23, V10_V23 -> Assertions.assertTrue(
          webhookB2bClient.consumeEventStreamV23(this.eventStreamListV23.get(0).getStreamId(), null)
              .isEmpty());
  ...
  public void readStreamTimelineElementAndVerifyDate() {
    ...
    try {
      ...
      EventTimestamp = progressResponseElementList.stream().filter(
              elem -> elem.getTimelineEventCategory().equals(
                  it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.model_v2.TimelineElementCategoryV20.REFINEMENT))
          .findAny().get().getTimestamp();
      NotificationTimestamp = sharedSteps.getSentNotification().getTimeline().stream().filter(
              elem -> elem.getCategory().equals(
                  it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementCategoryV23.SCHEDULE_REFINEMENT))
          .findAny().get().getDetails().getSchedulingDate();
  ...
  public void readStreamTimelineElementAndVerifyDateV23() {
    ...
    try {
      ...
      //TODO Verificare...
      EventTimestamp = progressResponseElementListV23.stream().filter(
              elem -> elem.getElement().getCategory().equals(TimelineElementCategoryV23.REFINEMENT))
  ...
  private <T> PnPollingWebhook getPnPollingWebhook(T timeLineOrStatus) {
    ...
    if (timeLineOrStatus instanceof TimelineElementCategoryV20) {
      ...
      pnPollingWebhook.setNotificationStatusV20(
          (it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.model_v2.NotificationStatus) timeLineOrStatus);
      progressResponseElementList.clear();
      pnPollingWebhook.setProgressResponseElementListV20(progressResponseElementList);
      ...
      pnPollingWebhook.setNotificationStatusV23(
          (it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.model_v2_3.NotificationStatus) timeLineOrStatus);
      progressResponseElementListV23.clear();
      pnPollingWebhook.setProgressResponseElementListV23(progressResponseElementListV23);
    } else {
      throw new IllegalArgumentException();
  ...
  private <T> ProgressResponseElement searchInWebhookV20(T timeLineOrStatus, String lastEventId,
      int deepCount) {
    ...
    PnPollingParameter pnPollingParameter = PnPollingParameter.builder()
        ...
        .build();
    PnPollingServiceWebhookV20 webhookV20 = (PnPollingServiceWebhookV20) sharedSteps.getPollingFactory()
        .getPollingService(PnPollingStrategy.WEBHOOK_V20);
    PnPollingResponseV20 pnPollingResponseV20 = webhookV20.waitForEvent(
        sharedSteps.getSentNotification().getIun(), pnPollingParameter);

    log.info("WEBHOOK_PROGRESS_RESPONSE_ELEMENT_V20: "
        + pnPollingResponseV20.getProgressResponseElementV20());
    if (pnPollingResponseV20.getProgressResponseElementV20() != null) {
      sharedSteps.setProgressResponseElements(
          pnPollingResponseV20.getProgressResponseElementListV20());
      return pnPollingResponseV20.getProgressResponseElementV20();
    }
    return null;
  }

  private <T> ProgressResponseElementV23 searchInWebhookV23(T timeLineOrStatus, String lastEventId,
      int deepCount, int position) {
    PnPollingWebhook pnPollingWebhook = getPnPollingWebhook(timeLineOrStatus);
    PnPollingServiceWebhookV23 webhookV23 = (PnPollingServiceWebhookV23) sharedSteps.getPollingFactory()
        .getPollingService(PnPollingStrategy.WEBHOOK_V23);
    PnPollingResponseV23 pnPollingResponseV23 = webhookV23.waitForEvent(
    ...
    log.info("WEBHOOK_PROGRESS_RESPONSE_ELEMENT_V23: "
        + pnPollingResponseV23.getProgressResponseElementV23());
    if (pnPollingResponseV23.getProgressResponseElementListV23() != null) {
      sharedSteps.setProgressResponseElementsV23(
          pnPollingResponseV23.getProgressResponseElementListV23());
      return pnPollingResponseV23.getProgressResponseElementV23();
    }
    return null;
  }

  private <T> ProgressResponseElement searchInWebhookFileNotFound(T timeLineOrStatus,
      String lastEventId, int deepCount) {
    ...
    ProgressResponseElement progressResponseElement = null;
    ResponseEntity<List<ProgressResponseElement>> listResponseEntity = webhookB2bClient.consumeEventStreamHttp(
        this.eventStreamList.get(0).getStreamId(), lastEventId);
    ...
    if (deepCount >= 200) {
      throw new IllegalStateException("LOP: PROGRESS-ELEMENTS: " + progressResponseElements
          + " WEBHOOK: " + this.eventStreamList.get(0).getStreamId() + " IUN: "
          + sharedSteps.getSentNotification().getIun() + " DEEP: " + deepCount);
    }
    ...
    for (ProgressResponseElement elem : progressResponseElements) {
      if ("REFUSED".equalsIgnoreCase(elem.getNewStatus().getValue())
          && elem.getValidationErrors() != null && elem.getValidationErrors().size() > 0) {
  ...
  private <T> ProgressResponseElementV23 searchInWebhookFileNotFoundV23(T timeLineOrStatus,
      String lastEventId, int deepCount) {
    ...
    ProgressResponseElementV23 progressResponseElement = null;
    ResponseEntity<List<ProgressResponseElementV23>> listResponseEntity = webhookB2bClient.consumeEventStreamHttpV23(
        this.eventStreamListV23.get(0).getStreamId(), lastEventId);
    int retryAfter = Integer.parseInt(listResponseEntity.getHeaders().get("retry-after").get(0));
    List<ProgressResponseElementV23> progressResponseElements = listResponseEntity.getBody();
    if (deepCount >= 200) {
      throw new IllegalStateException("LOP: PROGRESS-ELEMENTS: " + progressResponseElements
          + " WEBHOOK: " + this.eventStreamListV23.get(0).getStreamId() + " IUN: "
          + sharedSteps.getSentNotification().getIun() + " DEEP: " + deepCount);
    }
  ...
  public void userReadNotification(String recipient) {
    ...
    Assertions.assertDoesNotThrow(
        () -> webRecipientClient.getReceivedNotification(sharedSteps.getSentNotification().getIun(),
            null));
  ...
  public void checkViewedStateV23(String pa, String versione) {
    ...
    switch (versione) {
      case "V10":
        ProgressResponseElement progressResponseElement = searchInWebhookV20(
            NotificationStatus.VIEWED, null, 0);
        Assertions.assertNotNull(progressResponseElement);
        break;
      case "V23":
        ProgressResponseElementV23 progressResponseElementV23 = searchInWebhookV23(
            NotificationStatus.VIEWED, null, 0, 0);
  ...
  public void checkViewedState(String pa) {
    ...
    setPaWebhook(pa);
    ProgressResponseElement progressResponseElement = searchInWebhookV20(
        it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.model_v2.NotificationStatus.VIEWED,
        null, 0);
    Assertions.assertNotNull(progressResponseElement);
  }
  ...
  public void lastCreationProducedAnErrorWithStatusCode(String statusCode) {
    ...
    Assertions.assertTrue((this.notificationError != null) &&
        ...
        eventStreamList.size() == (requestNumber - 1)));
  }
  ...
  public void vieneVerificatoCheIlProgressResponseElementIdDelWebhookSiaIncrementaleESenzaDuplicatiV23() {
    ...
    try {
      ...
      throw new AssertionFailedError(
          assertionFailedError.getMessage() + " PROGRESS-ELEMENT: \n" + progressResponseElements);
    }
  ...
  public void readStreamNumberEventsV23(Integer numEventi, String versione) {
    switch (versione) {
      case "V10":
        Assertions.assertDoesNotThrow(() -> {
          List<ProgressResponseElement> progressResponseElements = webhookB2bClient.consumeEventStream(
              this.eventStreamList.get(0).getStreamId(), null);
          log.info("EventProgress: " + progressResponseElements);
  ...
  public void verificaCorrispondenzaTraIDetailDelWebhookEQuelliDellaTimeline()
    ...
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementDetailsV23 timelineElementDetails = sharedSteps.getTimelineElementV23()
        .getDetails();//PERCHè NON TENERLO NELLA CLASSE ?!

    it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.model_v2_3.TimelineElementDetailsV23 timelineElementWebhookDetails = sharedSteps.getProgressResponseElementV23()
        .getElement().getDetails();
  ...
  public void verificaDeanonimizzazioneDegliEventiDiTimelineAnalogico(String delega) {
    TimelineElementDetailsV23 timelineElementWebhookDetails = sharedSteps.getProgressResponseElementV23()
        .getElement().getDetails();
    ...
    verificaDeanonimizzazioneDegliEventiDiTimelinePresenzaDelega(timelineElementWebhookDetails,
        delega);
  }
  ...
  public void verificaDeanonimizzazioneDegliEventiDiTimelinePresenzaDelega(
      TimelineElementDetailsV23 timelineElementWebhookDetails, String delega) {
  ...
  public void vengonoLettiGliEventiDiTimelineDelloStreamDel(String versione) {
    ...
    try {
      switch (versione) {
        case "V10":
          webhookB2bClient.consumeEventStreamHttp(this.eventStreamListV23.get(0).getStreamId(),
              null);
          break;
        case "V23":
          webhookB2bClient.consumeEventStreamHttpV23(this.eventStreamList.get(0).getStreamId(),
              null);
          break;
        default:
          throw new IllegalArgumentException();
  ...
  private <T> TimelineElementSearchResult<T> getTimelineEventForStream(StreamVersion streamVersion,
    ...
    try {
      switch (streamVersion) {
        case V10 -> {
          ...
          result.setTimelineElementCategory(
              TimelineElementCategoryV20.valueOf(timelineEventCategory));
        ...
        case V23 -> {
          ...
          result.setTimelineElementCategory(
              TimelineElementCategoryV23.valueOf(timelineEventCategory));
          result.setWaiting(timingForElement.waiting());
          result.setNumCheck(timingForElement.numCheck());
          return (TimelineElementSearchResult<T>) result;
        }
      ...
      log.error("Wrong type t for streamVersion {}, error in cast {}", streamVersion,
  ...
  @SuppressWarnings("unchecked")
  private <T> StatusElementSearchResult<T> getStatusEventForStream(StreamVersion streamVersion,
  ...
  private boolean checkInternalTimeline(String timelineElementName, int numCheck, int waiting) {
    ...
    for (int i = 0; i < numCheck; i++) {
      ...
      threadWaitMilliseconds(waiting);
  ...
  private void createStreamRequest(StreamVersion streamVersion, List<String> filterValues,
      int number, String title, String eventType) {
    switch (streamVersion) {
      case V10 -> {
        ...
        for (int i = 0; i < number; i++) {
          ...
          streamRequest.setEventType(eventType.equalsIgnoreCase("STATUS") ?
              StreamCreationRequest.EventTypeEnum.STATUS
              : StreamCreationRequest.EventTypeEnum.TIMELINE);
      ...
      case V23 -> {
        ...
        for (int i = 0; i < number; i++) {
          ...
          streamRequest.setTitle(title + "_" + i);
          streamRequest.setEventType(eventType.equalsIgnoreCase("STATUS") ?
              StreamCreationRequestV23.EventTypeEnum.STATUS
              : StreamCreationRequestV23.EventTypeEnum.TIMELINE);
          streamRequest.setFilterValues(filterValues);
  ...
  private void createStream(String pa, StreamVersion streamVersion, List<String> listGroups,
      boolean replaceId, List<String> filteredValues, boolean forced) {
    try {
      switch (streamVersion) {
        case V10 -> {
          if (this.eventStreamList == null) {
        ...
        case V23 -> {
          if (this.eventStreamListV23 == null) {
          ...
          for (StreamCreationRequestV23 request : streamCreationRequestListV23) {
            ...
            try {
              StreamMetadataResponseV23 eventStream = webhookB2bClient.createEventStreamV23(
                  request);
              if (replaceId) {
                StreamMetadataResponseV23 eventStreamV23 =
                    webhookB2bClient.getEventStreamV23(
                        this.eventStreamListV23.get(0).getStreamId());
                sharedSteps.setEventStreamV23(eventStreamV23);
                Assertions.assertNotNull(eventStreamV23);
                Assertions.assertNotNull(eventStreamV23.getStreamId());
  ...
  private void disableStreamInternal(String pa) {
    try {
      for (StreamMetadataResponseV23 eventStream : eventStreamListV23) {
        StreamMetadataResponseV23 result = webhookB2bClient.disableEventStreamV23(
...
//        }
  ...
  private boolean deleteStreamWrapperWithoutReleaseStreamCreationSlot(StreamVersion streamVersion,
      String pa, UUID streamID) {
    try {
      switch (streamVersion) {
      ...
      this.notificationError = e;
      sharedSteps.setNotificationError(e);
      log.error("ERROR IN DELETE STREAM id {} streamVersion{} pa {}", streamID,
          streamVersion.name(), pa);
      return false;
    }
  }
