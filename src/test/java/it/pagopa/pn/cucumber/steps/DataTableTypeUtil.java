...
public class DataTableTypeUtil {
  ...
  @DataTableType
  public synchronized NewNotificationRequestV23 convertNotificationRequest(
    ...
    NewNotificationRequestV23 notificationRequest = (new NewNotificationRequestV23()
        ...
        .amount(getValue(data, AMOUNT.key) == null ? null
            : Integer.parseInt(getValue(data, AMOUNT.key)))
        .paymentExpirationDate(getValue(data, PAYMENT_EXPIRATION_DATE.key) == null ? null
            : getValue(data, PAYMENT_EXPIRATION_DATE.key))
        ...
        .physicalCommunicationType(
            (getValue(data, PHYSICAL_COMMUNICATION_TYPE.key) == null ? null :
                (getValue(data, PHYSICAL_COMMUNICATION_TYPE.key).equalsIgnoreCase(
        ...
        .paFee(getValue(data, PA_FEE.key) == null ? null
            : Integer.parseInt(getValue(data, PA_FEE.key)))
  ...
  private NewNotificationRequestV23 addDocument(NewNotificationRequestV23 notificationRequest,
      Map<String, String> data) {
    ...
    if (documentsToAdd.contains(";")) {
      for (String documentElem : documentsToAdd.split(";")) {
        notificationRequest = notificationRequest.addDocumentsItem(
            getNotificationDocument(documentElem));
      }
    } else {
      notificationRequest = notificationRequest.addDocumentsItem(
          getNotificationDocument(documentsToAdd));
    }
    return notificationRequest;
  ...
  @DataTableType
  public synchronized it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NewNotificationRequest convertNotificationRequestV1(
      Map<String, String> data) {
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NewNotificationRequest notificationRequestV1 = (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NewNotificationRequest()
        ...
        .addDocumentsItem(getValue(data, DOCUMENT.key) == null ? null
            : utils.newDocumentV1(getDefaultValue(DOCUMENT.key)))
        .pagoPaIntMode(
  ...
  @DataTableType
  public synchronized it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NewNotificationRequest convertNotificationRequestV2(
      Map<String, String> data) {
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NewNotificationRequest notificationRequestV2 = (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NewNotificationRequest()
        ...
        .addDocumentsItem(getValue(data, DOCUMENT.key) == null ? null
            : utils.newDocumentV2(getDefaultValue(DOCUMENT.key)))
        .pagoPaIntMode(
            (getValue(data, PAGOPAINTMODE.key) == null ? null :
                (getValue(data, PAGOPAINTMODE.key).equalsIgnoreCase("SYNC") ?
  ...
  @DataTableType
  public synchronized it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NewNotificationRequestV21 convertNotificationRequestV21(
      Map<String, String> data) {
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NewNotificationRequestV21 notificationRequest = (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NewNotificationRequestV21()
        ...
        .vat(getValue(data, VAT.key) == null ? null : Integer.parseInt(getValue(data, VAT.key)))
        .addDocumentsItem(getValue(data, DOCUMENT.key) == null ? null
            : utils.newDocumentV21(getDefaultValue(DOCUMENT.key)))
        .pagoPaIntMode(
            (getValue(data, PAGOPAINTMODE.key).equalsIgnoreCase("SYNC") ?
                ...
                :
                    (getValue(data, PAGOPAINTMODE.key).equalsIgnoreCase("ASYNC") ?
                        it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NewNotificationRequestV21.PagoPaIntModeEnum.ASYNC
                        : null
                    ))));
  ...
  @DataTableType
  public synchronized NotificationRecipientV23 convertNotificationRecipient(
      Map<String, String> data) {
    ...
    NotificationRecipientV23 notificationRecipient = (new NotificationRecipientV23()
        ...
        .digitalDomicile(
            getValue(data, DIGITAL_DOMICILE.key) == null ? null : (new NotificationDigitalAddress()
        ...
        .physicalAddress(
            getValue(data, PHYSICAL_ADDRES.key) == null ? null : new NotificationPhysicalAddress()
    ...
    //N PAGAMENTI
    if (getValue(data, PAYMENT.key) != null && getValue(data, PAYMENT_MULTY_NUMBER.key) != null
        && !getValue(data, PAYMENT_MULTY_NUMBER.key).isEmpty()) {
      ...
      for (int i = 0; i < Integer.parseInt(getValue(data, PAYMENT_MULTY_NUMBER.key)); i++) {
        ...
        addPaymentsItem.pagoPa(getValue(data, PAYMENT_PAGOPA_FORM.key) == null ? null :
            (getValue(data, PAYMENT_PAGOPA_FORM.key).equalsIgnoreCase("NO") ?
                null :
                new PagoPaPayment()
                    .creditorTaxId(getValue(data, PAYMENT_CREDITOR_TAX_ID.key) == null ? null
                        : getValue(data, PAYMENT_CREDITOR_TAX_ID.key))
                    .noticeCode(getValue(data, PAYMENT_NOTICE_CODE.key) == null ? null
                        : getValue(data, PAYMENT_NOTICE_CODE.key))
                    ...
                    .attachment(
                        getValue(data, PAYMENT_PAGOPA_FORM.key).equalsIgnoreCase("NOALLEGATO")
                            ? null
                            : utils.newAttachment(getDefaultValue(PAYMENT_PAGOPA_FORM.key)))));

        //LOAD METADATI F24
        if (getValue(data, PAYMENT_F24.key) != null && !getValue(data, PAYMENT_F24.key).isEmpty()) {
          setMetadatiF24(data, addPaymentsItem, i);

        } else if (getValue(data, PAYMENT_F24_X.key) != null && !getValue(data,
            PAYMENT_F24_X.key).isEmpty()) {
          setMetadatiF24(data, addPaymentsItem, i);
        }
  ...
  private void setMetadatiF24(Map<String, String> data, NotificationPaymentItem addPaymentsItem,
      int i) {

    if (!Objects.equals(getValue(data, PAYMENT_F24.key), null)) {
      addPaymentsItem.f24(
          new F24Payment()
              .title(getValue(data, TITLE_PAYMENT.key) != null ? getValue(data, TITLE_PAYMENT.key)
                  + "_" + i : null)
              .applyCost(getValue(data, PAYMENT_APPLY_COST_F24.key) == null ? null
                  : getValue(data, PAYMENT_APPLY_COST_F24.key).equalsIgnoreCase("SI"))
              .metadataAttachment(
                  getValue(data, PAYMENT_F24.key).equalsIgnoreCase("NO_METADATA_ATTACHMENT") ? null
                      :
      ...
      addPaymentsItem.f24(
          new F24Payment()
              ...
              .applyCost(applyCost)
              .metadataAttachment(
                  getNotificationMetadataAttachment(getValue(data, PAYMENT_F24_X.key) + "_" + i)));
    }

  }

  private NotificationMetadataAttachment getNotificationMetadataAttachment(
      String metadataAttachment) {
    ...
    switch (metadataAttachment.toUpperCase().trim()) {
      ...
      case "PAYMENT_F24_STANDARD_NO_VALID_LENGH" ->
          metadati = "classpath:/METADATA_CORRETTO_NO_VALID_LENGH.json";
      case "PAYMENT_F24_STANDARD_VALID_ANAG" ->
          metadati = "classpath:/METADATA_CORRETTO_VALID_103.json";
      case "PAYMENT_F24_STANDARD_NO_VALID_ANAG" ->
          metadati = "classpath:/METADATA_CORRETTO_VALID_104.json";
      case "PAYMENT_F24_STANDARD_NO_VALID_ANAG_1" ->
          metadati = "classpath:/METADATA_CORRETTO_VALID_105.json";
      case "PAYMENT_F24_STANDARD_NO_VALID_ANAG_2" ->
          metadati = "classpath:/METADATA_CORRETTO_VALID_106.json";
      case "PAYMENT_F24_STANDARD_NO_VALID_ANAG_3" ->
          metadati = "classpath:/METADATA_CORRETTO_VALID_107.json";
      case "PAYMENT_F24_STANDARD_NO_VALID_ANAG_4" ->
          metadati = "classpath:/METADATA_CORRETTO_VALID_108.json";
      case "PAYMENT_F24_STANDARD_NO_VALID_ANAG_5" ->
          metadati = "classpath:/test_invalid_metadata.json";
      ...
      case "PAYMENT_F24_STANDARD_REGION" ->
          metadati = "classpath:/f24_delivery_standard_region.json";
      case "PAYMENT_F24_STANDARD_LOCAL" -> metadati = "classpath:/f24_delivery_standard_local.json";
      case "PAYMENT_F24_STANDARD_TREASURY" ->
          metadati = "classpath:/f24_delivery_standard_treasury.json";
      case "PAYMENT_F24_STANDARD_TREASURY_AE" ->
          metadati = "classpath:/f24_delivery_standard_treasury_ae.json";
      case "PAYMENT_F24_STANDARD_SOCIAL" ->
          metadati = "classpath:/f24_delivery_standard_social.json";
      ...
      case "PAYMENT_F24_STANDARD_REGION_FLAT" ->
          metadati = "classpath:/f24_flat_standard_region.json";
      case "PAYMENT_F24_STANDARD_LOCAL_FLAT" ->
          metadati = "classpath:/f24_flat_standard_local.json";
      case "PAYMENT_F24_STANDARD_TREASURY_FLAT" ->
          metadati = "classpath:/f24_flat_standard_treasury.json";
      ...
      case "PAYMENT_F24_STANDARD_SOCIAL_FLAT" ->
          metadati = "classpath:/f24_flat_standard_social.json";
      case "PAYMENT_F24_STANDARD_INPS_ERR" ->
          metadati = "classpath:/f24_delivery_standard_inps_err.json";
      case "PAYMENT_F24_STANDARD_INPS_ERR_1" ->
          metadati = "classpath:/f24_delivery_standard_inps_err1.json";
      case "PAYMENT_F24_DELIVERY_STANDARD_LOCAL_TEFA" ->
          metadati = "classpath:/f24_delivery_standard_local_tefa.json";
      case "METADATO_CORRETTO_STAND_MINIMAL" ->
          metadati = "classpath:/METADATO_CORRETTO_STAND_MINIMAL.json";
      case "METADATO_CORRETTO_SIMPL_MINIMAL" ->
          metadati = "classpath:/METADATO_CORRETTO_SIMPL_MINIMAL.json";
      case "METADATO_CORRETTO_EXCISE_MINIMAL" ->
          metadati = "classpath:/METADATO_CORRETTO_EXCISE_MINIMAL.json";
      case "METADATO_CORRETTO_ELID_MINIMAL" ->
          metadati = "classpath:/METADATO_CORRETTO_ELID_MINIMAL.json";
  ...
  @DataTableType
  public synchronized it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationRecipient convertNotificationRecipientV1(
      Map<String, String> data) {
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationRecipient notificationRecipient = (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationRecipient()
        ...
        .taxId(getValue(data, TAX_ID.key))
        //.internalId(getValue(data,INTERNAL_ID.key))
        .digitalDomicile(getValue(data, DIGITAL_DOMICILE.key) == null ? null
            : (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationDigitalAddress()
                .type((getValue(data, DIGITAL_DOMICILE_TYPE.key) == null ?
                    null
                    : it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationDigitalAddress.TypeEnum.PEC))
                .address(getValue(data, DIGITAL_DOMICILE_ADDRESS.key)))
        )
        .physicalAddress(getValue(data, PHYSICAL_ADDRES.key) == null ? null
            : new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationPhysicalAddress()
                .address(getValue(data, PHYSICAL_ADDRESS_ADDRESS.key))
                .addressDetails(getValue(data, PHYSICAL_ADDRESS_DETAILS.key))
                .municipality(getValue(data, PHYSICAL_ADDRESS_MUNICIPALITY.key))
                .at(getValue(data, PHYSICAL_ADDRESS_AT.key))
        ...
        .payment(getValue(data, PAYMENT.key) == null ? null
                : new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v1.NotificationPaymentInfo()
                    .creditorTaxId(getValue(data, PAYMENT_CREDITOR_TAX_ID.key))
                    .noticeCode(getValue(data, PAYMENT_NOTICE_CODE.key))
                    .noticeCodeAlternative(
                        getValue(data, PAYMENT_NOTICE_CODE_OPTIONAL.key).equalsIgnoreCase("SI")
  ...
  @DataTableType
  public synchronized it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationRecipient convertNotificationRecipientV2(
      Map<String, String> data) {
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationRecipient notificationRecipientV2 = (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationRecipient()
        ...
        .digitalDomicile(getValue(data, DIGITAL_DOMICILE.key) == null ? null
            : (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationDigitalAddress()
                .type((getValue(data, DIGITAL_DOMICILE_TYPE.key) == null ?
                    null
                    : it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationDigitalAddress.TypeEnum.PEC))
                .address(getValue(data, DIGITAL_DOMICILE_ADDRESS.key)))
        )
        .physicalAddress(getValue(data, PHYSICAL_ADDRES.key) == null ? null
            : new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationPhysicalAddress()
                .address(getValue(data, PHYSICAL_ADDRESS_ADDRESS.key))
                .addressDetails(getValue(data, PHYSICAL_ADDRESS_DETAILS.key))
                .municipality(getValue(data, PHYSICAL_ADDRESS_MUNICIPALITY.key))
                .at(getValue(data, PHYSICAL_ADDRESS_AT.key))
        ...
        .payment(getValue(data, PAYMENT.key) == null ? null
                : new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v2.NotificationPaymentInfo()
                    .creditorTaxId(getValue(data, PAYMENT_CREDITOR_TAX_ID.key))
                    .noticeCode(getValue(data, PAYMENT_NOTICE_CODE.key))
                    .noticeCodeAlternative(
                        getValue(data, PAYMENT_NOTICE_CODE_OPTIONAL.key).equalsIgnoreCase("SI")
  ...
  @DataTableType
  public synchronized it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationRecipientV21 convertNotificationRecipientV21(
      Map<String, String> data) {
    ...
    it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationRecipientV21 notificationRecipient = (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationRecipientV21()
        ...
        //.internalId(getValue(data,INTERNAL_ID.key))
        .digitalDomicile(getValue(data, DIGITAL_DOMICILE.key) == null ? null
            : (new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationDigitalAddress()
                .type((getValue(data, DIGITAL_DOMICILE_TYPE.key) == null ?
                    null
                    : it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationDigitalAddress.TypeEnum.PEC))
                .address(getValue(data, DIGITAL_DOMICILE_ADDRESS.key)))
        )
        .physicalAddress(getValue(data, PHYSICAL_ADDRES.key) == null ? null
            : new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.NotificationPhysicalAddress()
                .address(getValue(data, PHYSICAL_ADDRESS_ADDRESS.key))
                .addressDetails(getValue(data, PHYSICAL_ADDRESS_DETAILS.key))
                .municipality(getValue(data, PHYSICAL_ADDRESS_MUNICIPALITY.key))
                .at(getValue(data, PHYSICAL_ADDRESS_AT.key))
        ...
        addPaymentsItem.pagoPa(getValue(data, PAYMENT_PAGOPA_FORM.key) == null ? null :
            (getValue(data, PAYMENT_PAGOPA_FORM.key).equalsIgnoreCase("NO") ?
                ...
                new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.PagoPaPayment()
                    ...
                    .noticeCode(getValue(data, PAYMENT_NOTICE_CODE.key))
                    .applyCost(
                        getValue(data, PAYMENT_APPLY_COST_PAGOPA.key).equalsIgnoreCase("SI") ? true
                            : false)
                    .attachment(
                        getValue(data, PAYMENT_PAGOPA_FORM.key).equalsIgnoreCase("NOALLEGATO")
                            ? null
                            : utils.newAttachmentV21(getDefaultValue(PAYMENT_PAGOPA_FORM.key)))));

        //LOAD METADATI F24
        if (getValue(data, PAYMENT_F24.key) != null && getValue(data,
            PAYMENT_F24.key).equalsIgnoreCase("PAYMENT_F24_FLAT")) {
          addPaymentsItem.f24(
              new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.F24Payment()
                  .title(getValue(data, TITLE_PAYMENT.key) + "_" + i)
                  .applyCost(
                      getValue(data, PAYMENT_APPLY_COST_F24.key).equalsIgnoreCase("SI") ? true
                          : false)
                  .metadataAttachment(
                      utils.newMetadataAttachmentV21("classpath:/METADATA_CORRETTO_FLAT.json")));

        } else if (getValue(data, PAYMENT_F24.key) != null && getValue(data,
            PAYMENT_F24.key).equalsIgnoreCase("PAYMENT_F24_STANDARD_0")) {
          addPaymentsItem.f24(
              new it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model_v21.F24Payment()
                  .title(getValue(data, TITLE_PAYMENT.key) + "_" + i)
                  .applyCost(
                      getValue(data, PAYMENT_APPLY_COST_F24.key).equalsIgnoreCase("SI") ? true
                          : false)
                  .metadataAttachment(
                      utils.newMetadataAttachmentV21("classpath:/METADATA_CORRETTO_0.json")));
  ...
  @DataTableType
  public synchronized DataTest convertTimelineElement(Map<String, String> data)
    ...
    TimelineElementV23 timelineElement = new TimelineElementV23()
        ...
        .details(getValue(data, DETAILS.key) == null ? null : new TimelineElementDetailsV23()
            ...
            .refusalReasons(
                getListValue(NotificationRefusedErrorV23.class, data, DETAILS_REFUSAL_REASONS.key))
            ...
            .digitalAddressSource(
                digitalAddressSource != null ? DigitalAddressSource.valueOf(digitalAddressSource)
                    : null)
            ...
            .isAvailable(
                isAvailable != null ? Boolean.valueOf(getValue(data, DETAILS_IS_AVAILABLE.key))
                    : null)
