...
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.AnalogAddress;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.CreateOperationRequest;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.NotificationRequest;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.NotificationsUnreachableResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.OperationResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.OperationsResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.SDNotificationSummary;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.SearchNotificationRequest;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.SearchResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.VideoUploadRequest;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDesk.model.VideoUploadResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.CourtesyMessage;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.DocumentsRequest;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.DocumentsResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.Mandate;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.NotificationDetailResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.NotificationResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.PaNotificationsRequest;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.PaSummary;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.ProfileRequest;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.ProfileResponse;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.RecipientType;
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.ResponseApiKeys;
...
import it.pagopa.pn.client.b2b.web.generated.openapi.clients.serviceDeskIntegration.model.TimelineResponse;
...
public class ApiServiceDeskSteps {
  ...
  @Autowired
  public ApiServiceDeskSteps(SharedSteps sharedSteps, RestTemplate restTemplate,
  ...
  public void NotificationsUnreachableResponse() {
    try {
      ...
      String message = assertionFailedError.getMessage() +
          "{Il cliente presenta un numero di pratiche" + (notificationsUnreachableResponse == null
          ? "NULL" : notificationsUnreachableResponse.getNotificationsCount()) + " }";
  ...
  public void verifyNotificationsUnreachableResponse(Long count) {
    ...
    log.info("Presenza notifiche per il CF" + this.notificationRequest.getTaxId() + ":"
        + notificationsCount);
  }
  ...
  public void operationProducedAnError(String statusCode) {
    ...
    log.info(
        "Errore: " + notificationError.getStatusCode() + " " + notificationError.getMessage() + " "
            + notificationError.getCause());
  }

  @Given("viene comunicato il nuovo indirizzo con {string} {string} {string} {string} {string} {string} {string} {string} {string}")
  public void createNewAddressRequest(String fullname, String namerow2, String address,
      String addressRow2, String cap, String city, String city2, String pr, String country) {
  ...
  public void createOperationResponse() {
    try {
      ...
      String message = assertionFailedError.getMessage() +
          "{Id operation " + (operationsResponse == null ? "NULL"
          : operationsResponse.getOperationId()) + " }";
      throw new AssertionFailedError(message, assertionFailedError.getExpected(),
          assertionFailedError.getActual(), assertionFailedError.getCause());
    }
  }
  ...
  public void verifyCreateOperationResponse() {
    ...
    log.info(
        "L'operation di creato per il CF:" + createOperationRequest.getTaxId() + " " + idOperation);
  }
  ...
  public void preUploadVideoResponse() {
    try {
      Assertions.assertDoesNotThrow(() -> {
        videoUploadResponse = ipServiceDeskClient.presignedUrlVideoUpload(
            operationsResponse.getOperationId(), videoUploadRequest);
      });
  ...
  public void loadFileSafeStorage() {
    ...
    notificationDocument.digests(
        new NotificationAttachmentDigests().sha256(videoUploadRequest.getSha256()));
  }
  ...
  public void createNewAddressRequestWrongApiKey(String fullname, String namerow2, String address,
      String addressRow2, String cap, String city, String city2, String pr, String country) {
    setAnalogAddressFields(fullname, namerow2, address, addressRow2, cap, city, city2, pr, country);
  }
  ...
  public void createNewAddressRequestNoApiKey(String fullname, String namerow2, String address,
      String addressRow2, String cap, String city, String city2, String pr, String country) {
    setAnalogAddressFields(fullname, namerow2, address, addressRow2, cap, city, city2, pr, country);
  }
  ...
  public void lOperatoreRichiedeLElencoDiDiTuttiIMessaggiDiCortesiaInviatiConRecipientTypeVuoto() {
    try {
      ...
      searchNotificationsResponse = ipServiceDeskClient.searchNotificationsFromTaxId(10, null, null,
          null, searchNotificationsRequest);
      threadWaitMilliseconds(getWorkFlowWait());
  ...
  public void lOperatoreRichiedeLElencoDiTuttiIMessaggiDiCortesiaInviatiConCfErratoERecipientType(
      String taxId, String recipientType, String searchPageSize, String searchNextPagesKey,
      String startDate, String endDate) {
    Integer size = setSearchPageSize(searchPageSize);
    String nextPagesKey = setNextPagesKey(searchNextPagesKey);

    checkElencoDelleNotificheRicevuteSteps(taxId, recipientType, searchPageSize, searchNextPagesKey,
        startDate, endDate, false);

    if (size == 50 && nextPagesKey == null) {
      Assertions.assertEquals(50,
          Objects.requireNonNull(searchNotificationsResponse.getResults()).size());
    }

    List<CourtesyMessage> listCourtesyMessage = new ArrayList<>();
    for (NotificationResponse notificationResponseTmp : Objects.requireNonNull(
        searchNotificationsResponse.getResults())) {
      if (notificationResponseTmp.getCourtesyMessages() != null
          && !notificationResponseTmp.getCourtesyMessages().isEmpty()) {
  ...
  public void comeOperatoreDevoAccedereAiDatiDelProfiloDiUnUtentePFEPGDiPiattaformaNotifiche(
      String taxId, String recipientType) {
    try {
  ...
  private void checkElencoDelleNotificheRicevuteSteps(String taxId, String recipientType,
      String searchPageSize, String searchNextPagesKey, String startDate, String endDate,
      boolean multiTaxId) {
    try {
      Integer size = setSearchPageSize(searchPageSize);
      String nextPagesKey = setNextPagesKey(searchNextPagesKey);
      ...
      searchNotificationsResponse = ipServiceDeskClient.searchNotificationsFromTaxId(size,
          nextPagesKey, sDate, eDate, searchNotificationsRequest);
      Assertions.assertNotNull(searchNotificationsResponse);
  ...
  public void comeOperatoreDevoAccedereAllElencoDelleNotificheRicevuteDaUnUtenteDiPiattaformaNotificheConCfERecipientType(
      String taxId, String recipientType, String searchPageSize, String searchNextPagesKey,
      String startDate, String endDate) {
    checkElencoDelleNotificheRicevuteSteps(taxId, recipientType, searchPageSize, searchNextPagesKey,
  ...
  public void recuperoDettaglioNotifica() {
    try {
      ...
      Assertions.assertFalse(searchNotificationsResponse.getResults().isEmpty());
      notificationDetailResponse = ipServiceDeskClient.getNotificationFromIUN(
          searchNotificationsResponse.getResults().get(0).getIun());
    } catch (HttpStatusCodeException exception) {
      this.notificationError = exception;
    }
  }
  ...
  public void invocazioneServizioPerRecuperoDettaglioTimelineNotifica(String taxid, String iun) {
    try {
      ...
      timelineResponse = ipServiceDeskClient.getTimelineOfIUNAndTaxId(iunSearch,
  ...
  public void invocazioneServizioPerRecuperoDettaglioTimelineNotificaMultidestinatarioConCfEIun(
      String taxId, String iun, Integer destinatario) {
    try {
      searchNotificationsRequest = new SearchNotificationsRequest();
  ...
  public void comeOperatoreDevoEffettuareUnCheckSullaDisponibilitaValiditaEDimensioneDegliAllegatiConIUNRecipientType(
      String iun, String taxId, String recipientType) {
    try {
      documentsRequest = new DocumentsRequest();
      if (sharedSteps.getSentNotification() != null) {
        setRecipientType(
            sharedSteps.getSentNotification().getRecipients().get(0).getRecipientType().getValue());
      } else {
        setRecipientType(recipientType);
      }
  ...
  public void comeOperatoreDevoAccedereAllaListaDelleNotifichePerLeQualiLUtenteRisultaDestinatarioComeDelegatoDiUnaPersonaFisicaODiUnaPersonaGiuridicaConCfRecipientTypeEConSearchPageSizeSearchNextPagesKeyStartDateEndDate(
      String type, String taxId, String recipientType, String searchPageSize,
      String searchNextPagesKey, String startDate, String endDate, String searchMandateId,
      String searchInternalId) {
    try {
      Assertions.assertNotNull(profileResponse);
      ...
      OffsetDateTime offsetEndDt = OffsetDateTime.of(OffsetDateTime.now().getYear(),
          OffsetDateTime.now().getMonth().getValue(), OffsetDateTime.now().getDayOfMonth(), 0, 0, 0,
          0,
          ZoneOffset.UTC);
      ...
      searchNotificationsResponse = ipServiceDeskClient.searchNotificationsAsDelegateFromInternalId(
          mandateIdSearch, delegateInternalIdSearch, recipientType, size, nextPagesKey, sDate,
          eDate);
      Assertions.assertNotNull(searchNotificationsResponse);
      Assertions.assertNotNull(searchNotificationsResponse.getResults());
      Assertions.assertFalse(searchNotificationsResponse.getResults().isEmpty());
  ...
  public void comeOperatoreDevoAccedereAllaListaDiTutteLeNotificheDepositateDaUnEnteMittenteSuPiattaformaNotificheInUnRangeTemporaleConPaIdEConSearchPageSizeSearchNextPagesKeyStartDateEndDate(
      String paId, String searchPageSize, String searchNextPagesKey, String startDate,
      String endDate) {
    try {
      Integer size = setSearchPageSize(searchPageSize);
      String nextPagesKey = setNextPagesKey(searchNextPagesKey);
      ...
      searchNotificationsResponse = ipServiceDeskClient.searchNotificationsFromSenderId(size,
          nextPagesKey, paNotificationsRequest);
      Assertions.assertNotNull(searchNotificationsResponse);
    } catch (HttpStatusCodeException exception) {
      this.notificationError = exception;
    }
  ...
  private void invocazioneServizioPerRecuperoDettaglioNotificaConIunSteps(String iun,
  ...
  public void comeOperatoreDevoAccedereAlleInformazioniRelativeAlleRichiesteDiAPIKeyAvanzateDaUnEnteMittenteDiNotificheSullaPiattaforma(
      String paId) {
    try {
  ...
  private void preUploadVideoResponseSteps(String operationId) {
    try {
      videoUploadResponse = ipServiceDeskClient.presignedUrlVideoUpload(operationId,
          videoUploadRequest);
      threadWaitMilliseconds(getWorkFlowWait());
      Assertions.assertNotNull(videoUploadResponse);
    } catch (HttpStatusCodeException exception) {
  ...
  private void operationProducedAnErrorSteps(String statusCode) {
    ...
    Assertions.assertEquals(notificationError.getStatusCode().toString().substring(0, 3),
        statusCode);
  }
  ...
  private void createPreUploadVideoRequestSteps(String preloadIdx, String contentType)
      throws Exception {
    String sha256 = getSha256ByVideoDocument();
  ...
  private void loadFileSafeStorageSteps() {
    ...
    loadToPresigned(videoUploadResponse.getUrl(), videoUploadResponse.getSecret(),
        videoUploadRequest.getSha256(), resourceName);
  ...
  private void searchResponseSteps() {
    try {
      ...
      String message = assertionFailedError.getMessage() +
          "{Ricerca effettuata " + (searchResponse == null ? "NULL"
          : Objects.requireNonNull(searchResponse.getOperations()).toString()) + " }";
      throw new AssertionFailedError(message, assertionFailedError.getExpected(),
          assertionFailedError.getActual(), assertionFailedError.getCause());
    }
  }
  ...
  private void checkOperationResponseList(List<OperationResponse> lista, String operationIdToSearch,
      String status, boolean checkIun, String iun) {
    //Analisi output
    ...
    try {
      ...
      String message =
          assertionFailedError.getMessage() + "{L'operation id non è presente nella lista"
              + foundOperationId + "}";
      throw new AssertionFailedError(message, assertionFailedError.getExpected(),
          assertionFailedError.getActual(), assertionFailedError.getCause());
    }
    ...
    if (checkIun) {
      ...
      try {
        ...
        String message = assertionFailedError.getMessage() + "{Lo iun non è associato al CF"
            + searchNotificationRequest.getTaxId() + "}";
        throw new AssertionFailedError(message, assertionFailedError.getExpected(),
            assertionFailedError.getActual(), assertionFailedError.getCause());
      }
    }
  ...
  private boolean checkRetetion(String fileKey, Integer retentionTime) {
    PnExternalServiceClientImpl.SafeStorageResponse safeStorageResponse = safeStorageClient.safeStorageInfoPnServiceDesk(
        fileKey);
  ...
  private void setAnalogAddressFields(String fullname, String namerow2, String address,
      String addressRow2, String cap, String city, String city2, String pr, String country) {
  ...
  public String setIUNNotifica(String iun) {
    ...
    if ("VUOTO".equalsIgnoreCase(iun)) {
      ...
      if (searchNotificationsResponse != null && searchNotificationsResponse.getResults() != null
          && !searchNotificationsResponse.getResults().isEmpty()) {
  ...
  public String setPaID(String paId) {
    ...
    if ("VUOTO".equalsIgnoreCase(paId)) {
      ...
      for (PaSummary paSummary : listPa) {
        ...
        if (paSummary.getName().contains("Milano") || paSummary.getName().contains("Verona")
            || paSummary.getName().contains("Palermo")) {
          paIDSearch = paSummary.getId();
          break;
        }
      }
