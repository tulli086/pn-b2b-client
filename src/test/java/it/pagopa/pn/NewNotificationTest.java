...
public class NewNotificationTest {
    ...
    public void insertNewNotification() {
        ...
        String zipToUse = "30121|VENEZIA|VE";
        ...
        NewNotificationRequestV23 request = new NewNotificationRequestV23()
                ...
                .addRecipientsItem( newRecipient( 
                        ...
                        RECIPIENT_TYPE_DIGITAL.NO_DIGITAL, RECIPIENT_TYPE_ANALOG.ANALOG_OK, zipToUse))
    ...
    public void insertNewNotificationMulti() {
        ...
        NewNotificationRequestV23 request = new NewNotificationRequestV23()
                ...
                .paProtocolNumber("" + System.currentTimeMillis())
                .addDocumentsItem( newDocument( "classpath:/sample.pdf" ) )
                .addRecipientsItem( newRecipient( false,"Leo ", "CNCGPP80A01H501J","classpath:/sample.pdf","classpath:/f24_flat.json", RECIPIENT_TYPE_DIGITAL.NO_DIGITAL, RECIPIENT_TYPE_ANALOG.ANALOG_KO, null))
                .addRecipientsItem( newRecipient( false, "Fiera", "FRMTTR76M06B715E","classpath:/sample.pdf","classpath:/f24_flat.json", RECIPIENT_TYPE_DIGITAL.DIGITAL_OK, RECIPIENT_TYPE_ANALOG.ANALOG_OK, null))
                ;
    ...
    private NotificationRecipientV23 newRecipient(boolean withapplycost, String prefix, String taxId, String resourcePath,
                                                  String resourcePathf24, RECIPIENT_TYPE_DIGITAL recipientTypeDigital, RECIPIENT_TYPE_ANALOG recipientTypeAnalog,
                                                  String zipToUse) {
        ...
        NotificationRecipientV23 recipient = new NotificationRecipientV23()
                ...
                .physicalAddress(
                        ...
                        new NotificationPhysicalAddress()
                                .address("Via@ok_RS 12")
                                .municipality(zipToUse==null?"MILANO":(zipToUse.split("\\|")[1]))
                                .province(zipToUse==null?"VE":(zipToUse.split("\\|")[2]))
                                .foreignState("ITALIA")
                                .zip(zipToUse==null?"20121":(zipToUse.split("\\|")[0])):
                        new NotificationPhysicalAddress()
        ...
        recipient.getPayments().add(new NotificationPaymentItem()
